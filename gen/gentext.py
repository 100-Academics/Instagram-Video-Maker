...
def saveResponse(headers, payload):
    ...
    while(stillGoing):
        ...
        if stream:
            ...
            print(f"Story is: {response_data}")
            stillGoing = False
            break
